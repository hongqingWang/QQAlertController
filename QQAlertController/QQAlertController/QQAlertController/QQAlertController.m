...
/**************************************** 宽/高 ****************************************/
#define QQ_ALERT_SCREEN_WIDTH                       [UIScreen mainScreen].bounds.size.width
#define QQ_ALERT_SCREEN_HEIGHT                      [UIScreen mainScreen].bounds.size.height
#define QQ_ALERT_BUTTON_HEIGHT                      44
#define QQ_ALERT_LINE_HEIGHT                        0.5

/**************************************** 颜色 ****************************************/
#define QQ_ALERT_BACKGROUND_COLOR_NORMAL            [UIColor colorWithRed:((float)((0xFFFFFF & 0xFF0000) >> 16))/255.0 green:((float)((0xFFFFFF & 0xFF00) >> 8))/255.0 blue:((float)(0xFFFFFF & 0xFF))/255.0 alpha:0.5]
#define QQ_ALERT_BACKGROUND_COLOR_SELECTED          [UIColor colorWithRed:((float)((0xE9E9E9 & 0xFF0000) >> 16))/255.0 green:((float)((0xE9E9E9 & 0xFF00) >> 8))/255.0 blue:((float)(0xE9E9E9 & 0xFF))/255.0 alpha:1.0]
#define QQ_ALERT_TITLE_COLOR                        [UIColor colorWithRed:((float)((0x592E12 & 0xFF0000) >> 16))/255.0 green:((float)((0x592E12 & 0xFF00) >> 8))/255.0 blue:((float)(0x592E12 & 0xFF))/255.0 alpha:1.0]
#define QQ_ALERT_MESSAGE_COLOR                      [UIColor colorWithRed:((float)((0x592E12 & 0xFF0000) >> 16))/255.0 green:((float)((0x592E12 & 0xFF00) >> 8))/255.0 blue:((float)(0x592E12 & 0xFF))/255.0 alpha:1.0]
#define QQ_ALERT_BUTTON_COLOR_DEFAULT               [UIColor colorWithRed:((float)((0x592E12 & 0xFF0000) >> 16))/255.0 green:((float)((0x592E12 & 0xFF00) >> 8))/255.0 blue:((float)(0x592E12 & 0xFF))/255.0 alpha:1.0]
#define QQ_ALERT_BUTTON_COLOR_DESTRUCTIVE           [UIColor colorWithRed:((float)((0x592E12 & 0xFF0000) >> 16))/255.0 green:((float)((0x592E12 & 0xFF00) >> 8))/255.0 blue:((float)(0x592E12 & 0xFF))/255.0 alpha:1.0]
#define QQ_ALERT_BUTTON_COLOR_CANCEL                [UIColor colorWithRed:((float)((0xFF6C1E & 0xFF0000) >> 16))/255.0 green:((float)((0xFF6C1E & 0xFF00) >> 8))/255.0 blue:((float)(0xFF6C1E & 0xFF))/255.0 alpha:1.0]
#define QQ_ALERT_LINE_COLOR                         [UIColor colorWithRed:((float)((0x4D4D4D & 0xFF0000) >> 16))/255.0 green:((float)((0x4D4D4D & 0xFF00) >> 8))/255.0 blue:((float)(0x4D4D4D & 0xFF))/255.0 alpha:0.3]

/**************************************** 字体 ****************************************/
#define QQ_ALERT_TITLE_FONT                         [UIFont fontWithName:@"PingFangSC-Semibold" size:18]
#define QQ_ALERT_MESSAGE_FONT                       [UIFont fontWithName:@"PingFangSC-Regular" size:13]
#define QQ_ALERT_BUTTON_FONT_DEFAULT                [UIFont fontWithName:@"PingFangSC-Regular" size:15]
#define QQ_ALERT_BUTTON_FONT_DESTRUCTIVE            [UIFont fontWithName:@"PingFangSC-Regular" size:15]
#define QQ_ALERT_BUTTON_FONT_CANCEL                 [UIFont fontWithName:@"PingFangSC-Regular" size:15]
...
#pragma mark ---------------------------- QQAlertAction begin --------------------------------
...
@property (nonatomic, copy) void (^propertyEvent)(QQAlertAction *action);
@end

@implementation QQAlertAction

- (id)copyWithZone:(NSZone *)zone {
    QQAlertAction *action = [[[self class] alloc] init];
...
- (instancetype)initWithTitle:(nullable NSString *)title style:(QQAlertActionStyle)style handler:(void (^ __nullable)(QQAlertAction *action))handler {
    if (self = [super init]) {
        ...
        if (style == QQAlertActionStyleDefault) {
            self.titleColor = QQ_ALERT_BUTTON_COLOR_DEFAULT;
            self.titleFont = QQ_ALERT_BUTTON_FONT_DEFAULT;
        } else if (style == QQAlertActionStyleDestructive) {
            self.titleColor = QQ_ALERT_BUTTON_COLOR_DESTRUCTIVE;
            self.titleFont = QQ_ALERT_BUTTON_FONT_DESTRUCTIVE;
        } else if (style == QQAlertActionStyleCancel) {
            self.titleColor = QQ_ALERT_BUTTON_COLOR_CANCEL;
            self.titleFont = QQ_ALERT_BUTTON_FONT_CANCEL;
        } else {
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        // footerCell指的是QQAlertControllerStyleActionSheet下的取消cell和QQAlertControllerStyleAlert下actions小于_maxNumberOfActionHorizontalArrangementForAlert时的cell
...
- (void)setAction:(QQAlertAction *)action {
    _action = action;
...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated {
    ...
    if (highlighted) {
        ...
        self.contentView.backgroundColor = QQ_ALERT_BACKGROUND_COLOR_SELECTED;
        
    } else {
        // 手指抬起时会来到这里
        self.backgroundColor = [UIColor clearColor];
        if (![self.reuseIdentifier isEqualToString:FOOTERCELL]) {
            self.contentView.backgroundColor = QQ_ALERT_BACKGROUND_COLOR_NORMAL;
        } else {
...
@end
#pragma mark ---------------------------- QQAlertControllerActionCell end --------------------------------

#pragma mark ---------------------------- QQAlertController begin --------------------------------

@interface QQAlertController ()<UIViewControllerTransitioningDelegate,UITableViewDataSource,UITableViewDelegate>
...
// action数组
@property (nonatomic) NSArray<QQAlertAction *> *actions;
// 取消样式的action数组
...
@property (nonatomic, assign) QQAlertControllerStyle preferredStyle;
@property (nonatomic, assign) QQAlertAnimationType animationType;
// 底部的cell数组
...
@property (nonatomic, assign) QQBackgroundViewAppearanceStyle backgroundViewAppearanceStyle;
...
+ (instancetype)qq_alertControllerWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(QQAlertControllerStyle)preferredStyle animationType:(QQAlertAnimationType)animationType {
    ...
    QQAlertController *alertController = [self alertControllerWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil];
    
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(QQAlertControllerStyle)preferredStyle animationType:(QQAlertAnimationType)animationType customView:(UIView *)customView {
    // 创建控制器
...
- (void)addAction:(QQAlertAction *)action {
    ...
    if (self.cancelActions.count && self.preferredStyle == QQAlertControllerStyleActionSheet) {
        if (action.style == QQAlertActionStyleCancel) { // 取消样式的按钮顺序排列
    ...
    if (self.preferredStyle == QQAlertControllerStyleActionSheet) {
        if (self.customCenterView && action.style != QQAlertActionStyleCancel) {
            NSLog(@"当自定义centerView时，QQAlertControllerStyleActionSheet下，除了取消样式的按钮之外，其余样式的按钮均不显示");
            [array removeObject:action];
            self.actions = array;
            [self layoutViewConstraints];
            return;
        }
        if (action.style == QQAlertActionStyleCancel && !self.customFooterView) {
        ...
        if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert && !self.customFooterView) {
            ...
            if (self.customCenterView) {
                NSLog(@"当自定义centerView时，QQAlertControllerStyleAlert下，action的个数最多只能是_maxNumberOfActionHorizontalArrangementForAlert个，超过_maxNumberOfActionHorizontalArrangementForAlert个的action将不显示");
                [array removeObject:action];
                self.actions = array;
                return;
            }
    ...
    action.propertyEvent = ^(QQAlertAction *action) {
        if (weakSelf.preferredStyle == QQAlertControllerStyleActionSheet) {
            if (action.style == QQAlertActionStyleCancel) {
                ...
                QQAlertControllerActionCell *footerCell = [weakSelf.footerCells objectAtIndex:index];
            ...
            if (weakSelf.actions.count <= maxNumberOfActionHorizontalArrangementForAlert) {
                ...
                QQAlertControllerActionCell *footerCell = weakSelf.footerCells[index];
                footerCell.action = action;
            } else {
                [weakSelf.actionTableView reloadData];
            }
...
- (void)addTextFieldWithConfigurationHandler:(void (^)(UITextField * _Nonnull))configurationHandler {
    ...
    NSAssert(self.preferredStyle == QQAlertControllerStyleAlert, @"QQAlertControllerStyleActionSheet样式拒绝添加文本输入框");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    QQAlertControllerActionCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([QQAlertControllerActionCell class]) forIndexPath:indexPath];
    QQAlertAction *action = self.dataSource[indexPath.row];
    cell.action = action;
    return cell;
}

- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return QQ_ALERT_BUTTON_HEIGHT;
}

- (void)tableView:(UITableView *)tableView willDiQQlayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    // 设置cell分割线整宽
 ...
 * 初始化
 */
- (instancetype)initWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(QQAlertControllerStyle)preferredStyle animationType:(QQAlertAnimationType)animationType customView:(UIView *)customView customHeaderView:(UIView *)customHeaderView customCenterView:(UIView *)customCenterView customFooterView:(UIView *)customFooterView {
    ...
    if (self = [super init]) {
        ...
        if (animationType == QQAlertAnimationTypeDefault) {
            if (self.preferredStyle == QQAlertControllerStyleAlert) {
                animationType= QQAlertAnimationTypeAlpha;
            } else if (self.preferredStyle == QQAlertControllerStyleActionSheet) {
                animationType = QQAlertAnimationTypeRaiseUp;
            } else {
                animationType = QQAlertAnimationTypeRaiseUp;
            }
        }
...
- (void)setupViewsOboutHeader:(UIView *)customHeaderView {
    ...
    if (!customHeaderView) { // 不是自定义的headerView
        ...
        /**
         * 如果`detailTitleLabel`有值,就设置`detailTitleLabel`的属性
         */
...
- (void)setupHeaderActionLine {
    ...
    headerActionLine.backgroundColor = QQ_ALERT_LINE_COLOR;
...
- (void)setupViewsAboutAction:(UIView *)customCenterView {
    ...
    if (!customCenterView) {
        ...
        actionTableView.separatorColor = QQ_ALERT_LINE_COLOR;
        ...
        [actionTableView registerClass:[QQAlertControllerActionCell class] forCellReuseIdentifier:NSStringFromClass([QQAlertControllerActionCell class])];
...
- (void)setupVFooterTopLine {
    ...
    footerTopLine.backgroundColor = QQ_ALERT_LINE_COLOR;
...
- (void)setupFooterView:(UIView *)customFooterView  {
    ...
    if (!customFooterView) { // 非自定义footerView
        ...
        footerView.backgroundColor = QQ_ALERT_BACKGROUND_COLOR_NORMAL;
...
- (void)createFooterCellWithAction:(QQAlertAction *)action {
    ...
    QQAlertControllerActionCell *footerCell = [[QQAlertControllerActionCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:FOOTERCELL];
    ...
    if (self.actions.count > 1) {
        ...
        line.backgroundColor = QQ_ALERT_LINE_COLOR;
...
- (void)clickedFooterCell:(UIButton *)sender {
    ...
    if (self.preferredStyle == QQAlertControllerStyleActionSheet) {
        QQAlertControllerActionCell *footerCell = (QQAlertControllerActionCell *)sender.superview;
        NSInteger index = [self.footerCells indexOfObject:footerCell];
        QQAlertAction *action = [self.cancelActions objectAtIndex:index];
        // 回调action的block
        if (action.handler) {
            action.handler(action);
        }
        ...
        if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
            QQAlertControllerActionCell *footerCell = (QQAlertControllerActionCell *)sender.superview;
            NSInteger index = [self.footerCells indexOfObject:footerCell];
            QQAlertAction *action = [self.actions objectAtIndex:index];
            // 回调action的block
            if (action.handler) {
                action.handler(action);
            }
...
- (void)touchDownFooterCell:(UIButton *)sender {
    ...
    sender.backgroundColor = QQ_ALERT_BACKGROUND_COLOR_SELECTED;
}

- (void)touchDragExitFooterCell:(UIButton *)sender {
    QQAlertControllerActionCell *footerCell = (QQAlertControllerActionCell *)sender.superview;
    footerCell.backgroundColor = QQ_ALERT_BACKGROUND_COLOR_NORMAL;
...
- (void)layoutHeader {
    ...
    [headerBezelViewConstraints addObject:[NSLayoutConstraint constraintWithItem:headerBezelView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationLessThanOrEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:QQ_ALERT_SCREEN_HEIGHT - QQ_ALERT_BUTTON_HEIGHT]];
    ...
    if (!self.customHeaderView) { // 非自定义的headerView
        ...
        if (_titleLabel.text.length || _detailTitleLabel.text.length) {
            ...
            [headerScrollContentViewConstraints addObject:[NSLayoutConstraint constraintWithItem:headerScrollContentView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationGreaterThanOrEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:QQ_ALERT_BUTTON_HEIGHT]];
        }
...
- (void)layoutHeaderActionLine {
    ...
    CGFloat headerActionPadding = (!headerBezelView.subviews.count || !self.actions.count) ? 0 : QQ_ALERT_LINE_HEIGHT;
...
- (void)layoutFooter {
    ...
    if ((self.preferredStyle == QQAlertControllerStyleActionSheet && self.cancelActions.count) || (self.preferredStyle == QQAlertControllerStyleAlert && (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) && self.actions.count)) { // 需要footerBezelView
        if (self.preferredStyle == QQAlertControllerStyleAlert) { // alert样式
            if (!self.customFooterView) { // 不是自定义的footerView
                [footerBezelViewConstraints addObject:[NSLayoutConstraint constraintWithItem:footerBezelView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:QQ_ALERT_BUTTON_HEIGHT]];
            ...
            [footerBezelViewConstraints addObject:[NSLayoutConstraint constraintWithItem:footerBezelView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0f constant:QQ_ALERT_BUTTON_HEIGHT * self.cancelActions.count]];
        }
    } else { // 不需要footerView
    ...
    if (!self.customFooterView) { // 不是自定义的footerView
        ...
        if (footerCells.count && ((self.preferredStyle == QQAlertControllerStyleActionSheet && self.cancelActions.count) || (self.preferredStyle == QQAlertControllerStyleAlert && self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert))) {
            [footerCells enumerateObjectsUsingBlock:^(QQAlertControllerActionCell *footerCell, NSUInteger idx, BOOL * _Nonnull stop) {
                if (self.preferredStyle == QQAlertControllerStyleAlert) {
                    // 设置footerCell的上下间距
                    ...
                    if (idx > 0) {
                        ...
                        // 分割线宽度
                        [footerCellConstraints addObject:[NSLayoutConstraint constraintWithItem:line attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.f constant:QQ_ALERT_LINE_HEIGHT]];
                        // cell的右边距
                    ...
                    if (idx > 0) {
                        ...
                        // 分割线的高度
                        [footerCellConstraints addObject:[NSLayoutConstraint constraintWithItem:line attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.f constant:QQ_ALERT_LINE_HEIGHT]];
                        // cell的底部间距
    ...
    if (self.actions.count) {
        if (self.preferredStyle == QQAlertControllerStyleActionSheet) {
            if (self.cancelActions.count) { // 有取消按钮肯定没有自定义footerView
                if (self.actions.count > 1) {
                    actionBezelHeight = self.actions.count * QQ_ALERT_BUTTON_HEIGHT + footerTopMargin;
                } else {
                    if (self.customCenterView) { // 当有自定义的customCenterView时，最多只会有1个action，在addAction:方法里做了处理
                        actionBezelHeight = QQ_ALERT_BUTTON_HEIGHT + footerTopMargin+_customCenterViewSize.height;
                    } else {
                        actionBezelHeight = QQ_ALERT_BUTTON_HEIGHT + footerTopMargin;
                    }
                }
            } else {
                if (self.customCenterView) {
                    ...
                    if (self.customFooterView) {
                        actionBezelHeight = self.actions.count * QQ_ALERT_BUTTON_HEIGHT+_customFooterViewSize.height;
                    } else {
                        actionBezelHeight = self.actions.count * QQ_ALERT_BUTTON_HEIGHT;
                    }
                }
            }
            
        } else if (self.preferredStyle == QQAlertControllerStyleAlert) {
            ...
            if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
                if (!self.customCenterView) { // 当没有自定义的customCenterView时，最多只会有_maxNumberOfActionHorizontalArrangementForAlert个action，在addAction:方法里做了处理
                    if (self.customFooterView) {
                        actionBezelHeight = _customFooterViewSize.height + QQ_ALERT_BUTTON_HEIGHT;
                    } else {
                        actionBezelHeight = QQ_ALERT_BUTTON_HEIGHT;
                    }
                } else { // _maxNumberOfActionHorizontalArrangementForAlert个以上action且customCenterView有值
                    actionBezelHeight = _customCenterViewSize.height + QQ_ALERT_BUTTON_HEIGHT;
                }
            } else {
                if (self.customFooterView) {
                    
                    actionBezelHeight = _customFooterViewSize.height+self.actions.count * QQ_ALERT_BUTTON_HEIGHT;
...
- (CGFloat)minActionHeight:(CGFloat)footerTopMargin {
    ...
    if (self.cancelActions.count) {
        if ((self.actions.count-self.cancelActions.count) > 3) { // 有取消按钮且其余按钮个数在3个或3个以上
            // 让其余按钮至少显示2个半
            minActionHeight = self.cancelActions.count * QQ_ALERT_BUTTON_HEIGHT +2.5 * QQ_ALERT_BUTTON_HEIGHT+footerTopMargin;
        } else {
            minActionHeight = self.actions.count * QQ_ALERT_BUTTON_HEIGHT + footerTopMargin;
        }
    } else {
        if (self.actions.count > 3) { // 没有取消按钮，其余按钮在3个或3个以上
            if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
                ...
                minActionHeight = 3.5 * QQ_ALERT_BUTTON_HEIGHT;
            }
        } else {
            if (self.preferredStyle == QQAlertControllerStyleAlert) {
                if (self.actions.count) {
                    minActionHeight = QQ_ALERT_BUTTON_HEIGHT;
                }
            } else {
                minActionHeight = self.actions.count * QQ_ALERT_BUTTON_HEIGHT;
            }
        }
    }
...
- (void)setMaxMarginForAlert:(CGFloat)maxMarginForAlert {
    ...
    if (self.customView) {
        ...
        if (self.preferredStyle == QQAlertControllerStyleAlert) {
            if (_customViewSize.width >= QQ_ALERT_SCREEN_WIDTH-2*maxMarginForAlert) {
                _customViewSize.width = QQ_ALERT_SCREEN_WIDTH-2*maxMarginForAlert;
            }
        } else {
            if (_customViewSize.width >= QQ_ALERT_SCREEN_WIDTH) {
                _customViewSize.width = QQ_ALERT_SCREEN_WIDTH;
            }
        }
        [self layoutCustomView];
    } else {
        ...
        if (self.preferredStyle == QQAlertControllerStyleAlert) {
            if (_customHeaderViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*maxMarginForAlert) {
                _customHeaderViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*maxMarginForAlert;
            }
            if (_customCenterViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*maxMarginForAlert) {
                _customCenterViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*maxMarginForAlert;
            }
            if (_customFooterViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*maxMarginForAlert) {
                _customFooterViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*maxMarginForAlert;
            }
        } else {
            
            if (_customHeaderViewSize.width >= QQ_ALERT_SCREEN_WIDTH) {
                _customHeaderViewSize.width = QQ_ALERT_SCREEN_WIDTH;
            }
            if (_customCenterViewSize.width >= QQ_ALERT_SCREEN_WIDTH) {
                _customCenterViewSize.width = QQ_ALERT_SCREEN_WIDTH;
            }
            if (_customFooterViewSize.width >= QQ_ALERT_SCREEN_WIDTH) {
                _customFooterViewSize.width = QQ_ALERT_SCREEN_WIDTH;
            }
        }
        [self layoutViewConstraints];
    }
...
- (void)setOffsetYForAlert:(CGFloat)offsetYForAlert {
    ...
    QQAlertPresentationController *presentationVc = (QQAlertPresentationController *)self.presentationController;
...
- (void)setCustomView:(UIView *)customView {
    ...
    if (_customViewSize.width <= 0 || _customViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert) {
        _customViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert;
    }
...
- (void)setCustomHeaderView:(UIView *)customHeaderView {
    ...
    if (_customHeaderViewSize.width <= 0 || _customHeaderViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert) {
        _customHeaderViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert;
    }
...
- (void)setCustomCenterView:(UIView *)customCenterView {
    ...
    if (_customCenterViewSize.width <= 0 || _customCenterViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert) {
        _customCenterViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert;
    }
...
- (void)setCustomFooterView:(UIView *)customFooterView {
    ...
    if (_customFooterViewSize.width <= 0 || _customFooterViewSize.width >= QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert) {
        _customFooterViewSize.width = QQ_ALERT_SCREEN_WIDTH -2*_maxMarginForAlert;
    }
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = QQ_ALERT_TITLE_COLOR;
        _titleLabel.font = QQ_ALERT_TITLE_FONT;
...
- (UILabel *)detailTitleLabel {
    ...
    if (!_detailTitleLabel) {
        ...
        _detailTitleLabel.textColor = QQ_ALERT_MESSAGE_COLOR;
        _detailTitleLabel.font = QQ_ALERT_MESSAGE_FONT;
        // 设置垂直方向的抗压缩优先级,优先级越高越不容易被压缩,默认的优先级是750
...
- (void)keyboardWillChange:(NSNotification *)notification {
    ...
    CGFloat diff = fabs((QQ_ALERT_SCREEN_HEIGHT -keyboardEndY)*0.5);
...
- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source {
    return [QQAlertAnimation animationIsPresenting:YES];
}

- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    [self.view endEditing:YES];
    return [QQAlertAnimation animationIsPresenting:NO];
}

- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source NS_AVAILABLE_IOS(8_0) {
    return [[QQAlertPresentationController alloc] initWithPresentedViewController:presented presentingViewController:presenting];
}

@end

#pragma mark ---------------------------- QQAlertController end --------------------------------

@interface QQOverlayView: UIView
@property (nonatomic, strong) UIView *presentedView;
@property (nonatomic, assign) QQAlertController *alertController;
@property (nonatomic, strong) UIVisualEffectView *effectView;
@property (nonatomic, assign) CGFloat cornerRadiusForAlert;
- (void)redrawWithView:(UIView *)view alertController:(QQAlertController *)alertController;
@end

@implementation QQOverlayView
...
- (void)setAppearanceStyle:(QQBackgroundViewAppearanceStyle)appearanceStyle alpha:(CGFloat)alpha {
    switch (appearanceStyle) {
        case QQBackgroundViewAppearanceStyleTranslucent: {
            ...
            break;
        case QQBackgroundViewAppearanceStyleBlurExtraLight: {
            UIBlurEffect *blur = [UIBlurEffect effectWithStyle:UIBlurEffectStyleExtraLight];
            [self createVisualEffectViewWithBlur:blur alpha:alpha];
        }
            break;
        case QQBackgroundViewAppearanceStyleBlurLight: {
            UIBlurEffect *blur = [UIBlurEffect effectWithStyle:UIBlurEffectStyleLight];
            [self createVisualEffectViewWithBlur:blur alpha:alpha];
        }
            break;
        case QQBackgroundViewAppearanceStyleBlurDark: {
...
- (void)drawRect:(CGRect)rect {
    [super drawRect:rect];
    // 黑色带透明时进行镂空
    if (self.alertController.backgroundViewAppearanceStyle == QQBackgroundViewAppearanceStyleTranslucent && self.alertController.needDialogBlur && !self.alertController.textFields.count) {
        _cornerRadiusForAlert = (self.alertController.preferredStyle==QQAlertControllerStyleActionSheet)? 0 : self.alertController.cornerRadiusForAlert;
...
#pragma mark ---------------------------- QQAlertPresentationController begin --------------------------------

@interface QQAlertPresentationController()
@property (nonatomic, weak) QQOverlayView *overlayView;
@property (nonatomic, strong) NSMutableArray *presentedViewConstraints;
@end

@implementation QQAlertPresentationController
...
- (void)didChangeStatusBarOrientation:(NSNotification *)notification {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        QQAlertController *alertController = (QQAlertController *)self.presentedViewController;
        CGFloat cornerRadius = 0;
        if (alertController.preferredStyle == QQAlertControllerStyleAlert) {
...
- (void)presentationTransitionWillBegin {
    ...
    QQOverlayView *overlayView = [[QQOverlayView alloc] init];
...
- (void)updateConstraints {
    ...
    if (!customView) { // 非自定义
        if (alertController.preferredStyle == QQAlertControllerStyleActionSheet) {
            [presentedViewConstraints addObject: [NSLayoutConstraint constraintWithItem:presentedView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:QQ_ALERT_SCREEN_WIDTH]];
            ...
            if (alertController.animationType == QQAlertAnimationTypeDropDown) {
        ...
        } else if (alertController.preferredStyle == QQAlertControllerStyleAlert) {
            [presentedViewConstraints addObject: [NSLayoutConstraint constraintWithItem:presentedView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:(MIN(QQ_ALERT_SCREEN_WIDTH, QQ_ALERT_SCREEN_HEIGHT)-2*maxMarginForAlert)]];
            [presentedViewConstraints addObject: [NSLayoutConstraint constraintWithItem:presentedView attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.containerView attribute:NSLayoutAttributeCenterX multiplier:1.0 constant:0]];
...
#pragma mark ---------------------------- QQAlertPresentationController end --------------------------------


#pragma mark ---------------------------- QQAlertAnimation begin --------------------------------

@interface QQAlertAnimation()
@property (nonatomic, assign) BOOL presenting;
@property (nonatomic, assign) CGFloat delayTime;
@end

@implementation QQAlertAnimation
...
- (void)presentAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    QQAlertController *alertController = (QQAlertController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    CGSize controlViewSize = alertController.view.bounds.size;
    
    // 获取presentationController，注意不是presentedController
    QQAlertPresentationController *presentedController = (QQAlertPresentationController *)alertController.presentationController;
    QQOverlayView *overlayView = presentedController.overlayView;
    
    switch (alertController.animationType) {
        case QQAlertAnimationTypeRaiseUp:
            [self raiseUpWhenPresentForController:alertController
                                       transition:transitionContext
                                  controlViewSize:controlViewSize
                                      overlayView:overlayView];
            break;
        case QQAlertAnimationTypeDropDown:
...
- (void)dismissAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    QQAlertController *alertController = (QQAlertController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    CGSize controlViewSize = alertController.view.bounds.size;
    // 获取presentationController，注意不是presentedController
    QQAlertPresentationController *presentedController = (QQAlertPresentationController *)alertController.presentationController;
    QQOverlayView *overlayView = presentedController.overlayView;
...
// 从底部忘上弹的present动画
- (void)raiseUpWhenPresentForController:(QQAlertController *)alertController
                             transition:(id<UIViewControllerContextTransitioning>)transitionContext
                        controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
    
    CGRect controlViewFrame = alertController.view.frame;
    controlViewFrame.origin.y = QQ_ALERT_SCREEN_HEIGHT;
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0.0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        CGRect controlViewFrame = alertController.view.frame;
        controlViewFrame.origin.y = QQ_ALERT_SCREEN_HEIGHT -controlViewSize.height-alertBottomMargin;
        alertController.view.frame = controlViewFrame;
        overlayView.alpha = 1;
...
// 从底部往上弹对应的dismiss动画
- (void)dismissCorrespondingRaiseUpForController:(QQAlertController *)alertController
                                      transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                 controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
...
// 从顶部往下弹的present动画
- (void)dropDownWhenPresentForController:(QQAlertController *)alertController
                              transition:(id<UIViewControllerContextTransitioning>)transitionContext
                         controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
...
// 从顶部往下弹对应的dismiss动画
- (void)dismissCorrespondingDropDownForController:(QQAlertController *)alertController
                                       transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                  controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
- (void)alphaWhenPresentForController:(QQAlertController *)alertController
                           transition:(id<UIViewControllerContextTransitioning>)transitionContext
                      controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
...
- (void)dismissCorrespondingAlphaForController:(QQAlertController *)alertController
                                    transition:(id<UIViewControllerContextTransitioning>)transitionContext
                               controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
// 发散的prensent动画
- (void)expandWhenPresentForController:(QQAlertController *)alertController
                            transition:(id<UIViewControllerContextTransitioning>)transitionContext
                       controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
...
// 发散对应的dismiss动画
- (void)dismissCorrespondingExpandForController:(QQAlertController *)alertController
                                     transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
// 收缩的present动画
- (void)shrinkWhenPresentForController:(QQAlertController *)alertController
                            transition:(id<UIViewControllerContextTransitioning>)transitionContext
                       controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
...
// 收缩对应的的dismiss动画
- (void)dismissCorrespondingShrinkForController:(QQAlertController *)alertController
                                     transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                controlViewSize:(CGSize)controlViewSize overlayView:(QQOverlayView *)overlayView {
    // 与发散对应的dismiss动画相同
...
#pragma mark ---------------------------- QQAlertAnimation end --------------------------------
